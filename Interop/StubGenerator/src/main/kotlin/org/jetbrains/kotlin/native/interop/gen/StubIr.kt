...
sealed class PropertyAccessor : FunctionalStub {
    ...
    sealed class Setter : PropertyAccessor() {
        ...
        open override val parameters: List<FunctionParameterStub> = emptyList()
        ...
        class ExternalSetter(
                parameter: FunctionParameterStub,
                override val annotations: List<AnnotationStub> = emptyList()
        ) : Setter() {
            override val parameters: List<FunctionParameterStub> = listOf(parameter)
        }
